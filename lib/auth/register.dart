            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  Text("Register", style: TextStyle(fontSize: screenWidth * 0.06, fontWeight: FontWeight.bold)),
                  const Spacer(flex: 2),
                ],
              ),
            ),
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Create your account", style: TextStyle(fontSize: screenWidth * 0.07, fontWeight: FontWeight.w600)),
                    const SizedBox(height: 8),
                    Text("Join the GEM Smart Guide experience.", style: TextStyle(color: Colors.black54)),
                      ...
                      child: Column(
                        children: [
                          ...
                          Align(
                            ...
                            child: Text("Password Strength", style: TextStyle(fontSize: screenWidth * 0.04, fontWeight: FontWeight.bold)),
                          ),
